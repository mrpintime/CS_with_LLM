...
class search_hotels_Input(BaseModel):
    location: Optional[str] = Field(description='location (Optional[str]): This have to be only Name of The location of the hotel. Defaults to None.')
...
class search_hotels_Tool(BaseTool):
    ...
    description = (
        ...
        Args:
            location (Optional[str]): This have to be only Name of The location of the hotel. Defaults to None.
            name (Optional[str]): The name of the hotel. Defaults to None.
            price_tier (Optional[str]): The price tier of the hotel. Defaults to None. Examples: Midscale, Upper Midscale, Upscale, Luxury
            checkin_date (Optional[Union[datetime, date]]): The check-in date of the hotel. Defaults to None.
            checkout_date (Optional[Union[datetime, date]]): The check-out date of the hotel. Defaults to None.
